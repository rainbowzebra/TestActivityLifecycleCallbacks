...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabPadding = ScreenUtil.getScalePxValue(40);// 24
    ...
    private ChosedPlate chosedPlate;

    public ChosedPlate getChosedPlate() {
        return chosedPlate;
    }

    public void setChosedPlate(ChosedPlate chosedPlate) {
        this.chosedPlate = chosedPlate;
    }
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs,
        ...
        // 该句为原来的代码,注释掉.准备修改其宽度.在onDraw()方法中也有修改的代码
        ...
        // l.leftMargin = WWScreenUtils.getScalePxValue(262);
        // tabsContainer.setLayoutParams(l);
        // 以上几句为新加的代码
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                if (i == selectedPosition) {
                    if (chosedPlate != null) {
                        chosedPlate.chosed(selectedPosition);
                    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(lineLeft, height - indicatorHeight, lineRight, height,
                rectPaint);
        // 为了不占屏幕的一半,现改一下宽度
        // canvas.drawRect(lineLeft + WWScreenUtils.getScalePxValue(200), height
        // - indicatorHeight, lineRight, height, rectPaint);
